...
class Doacao(models.Model):
    """
    Model para doações feitas para itens de campanhas.
    Registra cada doação individual de uma doadora para um item específico.
    """
    STATUS_CHOICES = [
        ('pendente', 'Pendente'),
        ('confirmada', 'Confirmada pela Beneficiária'),
        ('cancelada', 'Cancelada'),
    ]
    ...
    campanha = models.ForeignKey(
        ...
        verbose_name="Campanha",
        help_text="Campanha para qual a doação foi feita"
    )
    item = models.ForeignKey(
        ...
        related_name='doacoes',
        verbose_name="Item",
        help_text="Item específico que foi doado"
    )
    doadora = models.ForeignKey(
        ...
        help_text="Pessoa que fez a doação"
    )
    quantidade = models.PositiveIntegerField(
        verbose_name="Quantidade",
        help_text="Quantidade doada"
    )
    mensagem = models.TextField(
        blank=True,
        default="",
        verbose_name="Mensagem",
        help_text="Mensagem opcional da doadora"
    )
    ...
    data_confirmacao = models.DateTimeField(
        ...
        help_text="Data em que a beneficiária confirmou o recebimento"
    )
    ...
    def __str__(self):
        return f"{self.doadora.nome_exibicao} → {self.campanha.titulo} ({self.quantidade} {self.item.unidade})"
